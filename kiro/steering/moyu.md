...
name: moyu
description: >
  Anti-over-engineering skill. Activates when AI modifies unrequested code,
  creates unnecessary abstractions, adds unsolicited comments/docs/tests,
  introduces unrequested dependencies, or exceeds requested diff scope.
---
